...
def fast_max_flow(gt_graph, i, j):
    ...
    # res = gt.push_relabel_max_flow(gt_graph, gt_graph.vertex(i), gt_graph.vertex(j), cap)
    res = gt.edmonds_karp_max_flow(gt_graph, gt_graph.vertex(i), gt_graph.vertex(j), cap)
